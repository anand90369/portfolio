var e=[{id:`building-ai-powered-react-apps`,title:`Building AI-Powered React Apps with Claude API`,date:`2026-03-15`,tags:[`AI`,`React`,`Claude API`,`Tutorial`],excerpt:`A deep dive into integrating Claude API into React applications. Learn how to build intelligent features like smart search, content generation, and conversational interfaces.`,content:`
## Why AI in Frontend?
...
`},{id:`mastering-framer-motion`,title:`Mastering Framer Motion: Animations That Ship`,date:`2026-02-28`,tags:[`React`,`Animation`,`Framer Motion`,`UI/UX`],excerpt:`Stop over-engineering animations. Learn the practical patterns I use in production to create smooth, performant animations with Framer Motion.`,content:`
...
`},{id:`fullstack-project-architecture`,title:`How I Structure Full-Stack Projects in 2026`,date:`2026-01-20`,tags:[`Architecture`,`Full-Stack`,`Best Practices`],excerpt:`My battle-tested project architecture for React + Node.js apps. Covers folder structure, API design, state management, and deployment strategies.`,content:`
